...
const buildServiceTags = (name = '', categoryName = '') => {
  ...
  const servicePhrases = [
    ...
    `${baseName} design`,
    `${baseName} designs`,
    `${baseName} banane wala`,
    `${baseName} ka kaam`,
    `${baseName} ka kaam karne wala`,
    `${baseName} wala`,
  ...
  return unique([
    ...
    ...localAreas.flatMap(area => [
      ...
      `${baseName} ka kaam in ${area}`,
      `${baseName} banane wala in ${area}`,
      `best ${baseName} in ${area}`,
      `best ${baseName} service in ${area}`,
      `best ${baseName} ka kaam in ${area}`,
      `best ${baseName} banane wala in ${area}`,
